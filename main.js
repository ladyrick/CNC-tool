...
var tab1 = new Vue({
    ...
    computed: {
        ...
        chidao: function () {
            return this.chidao_list[this.luoju_list.indexOf(this.luoju)].map((value, index) => ({
                index: index + 1,
                value: value,
            }));
        },
...
var tab2 = new Vue({
    ...
    data: {
        ...
        database: [
            ...
            ['铝', '粗加工', '2~3', '140~200', '0.2~0.4', 'YG类'],
            ['铝', '精加工', '0.2~0.3', '220~350', '0.1~0.2', 'YG类'],
            ['铝', '切断(宽度<5mm)', '~', '120~180', '0.1~0.2', 'YG类'],

            ['黄铜', '粗加工', '2~4', '120~180', '0.2~0.4', 'YG类'],
            ['黄铜', '精加工', '0.1~0.15', '200~250', '0.1~0.2', 'YG类'],
            ['黄铜', '切断(宽度<5mm)', '~', '120~160', '0.1~0.2', 'YG类'],
        ],
        d: '',
    },
    computed: {
